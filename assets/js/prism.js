/* PrismJS 1.29.0
https://prismjs.com/download.html?ref=ghost.org#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+docker+go+handlebars+json+json5+markup-templating+rust+toml+typescript+wasm+yaml+zig */
var _self =
